...
const Wallet = (props) => {
    ...
    const handleTransferAmountSubmit = async () => {
        ...
        if (Number(trnfAmount) <= 0) {
            toast.error("Enter transferred amount", {
              ...
              <p> <span>2</span>BTC</p> */}
                    ...
                    >
                        <BootstrapDialogTitle id="customizeddd-dialog-title" onClose={handleTransferClose}>
                            <span style={{ "fontsize": "2px" }}>Transfer to Spot Wallet </span>
