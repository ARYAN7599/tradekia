...
import LgnHistory from "../LgnHistory/LgnHistory";
...
function ProfileInfo(props) {
    ...
    return (
        ...
        <div className="prfi_div">
            ...
            <h2 className="prfi_title" onClick={handleFooPress}>Profile</h2>
                <Badge
                    overlap="circular"
                ...
                <div className="prfi_btnbox">
                  ...
                  :(iskyc===1)?
                    ...
                    <div className="prfi_flex1">
                        ...
                        <div className="prfi_flex2">
                            <GroupAddIcon className="prfi_svg" />
                            <p className="prfi_text">Bank</p>
                        </div>

                        <div>
                            <div className="prfi_flex2 dfgh">
                                <p className="bioford" onClick={handleBarPress}>Bank Details</p>
                                <ArrowRightIcon style={{ color: 'var(--background-color)' }} />
                            </div>
                        </div>
                    </div>
